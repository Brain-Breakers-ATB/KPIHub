...
const StudentTelegramChannel = mongoose.model<StudentTelegramChannelDoc, StudentTelegramChannelModelInterface>(
  'studenttelegramchannels',
  studentTelegramChannelSchema
);
